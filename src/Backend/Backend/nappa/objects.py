...
class SleepRecording:
    ...
    """
    def __init__(self, features, labels=None, wear_idx=None, clinical_id=None,
     serial_number=None, comments=None, id=None,  age=None, timestamps=None, sampling_interval=None):
        """
